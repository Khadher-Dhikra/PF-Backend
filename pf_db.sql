...
CREATE TABLE `milestones` (
  ...
  `status` enum('a_venir','en_cours','termine') DEFAULT 'a_venir',
...
CREATE TABLE `projects` (
  ...
  `description` text,
  `status` enum('en_cours','termine','en_retard') DEFAULT 'en_cours',
...
-- Dump completed on 2026-04-15 10:07:23
